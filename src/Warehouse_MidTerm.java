...
public class Warehouse_MidTerm extends Application
{
	...
	final int[][] arrayINT = new int[9][9];
	...
	public void start(Stage stage)
	{
		...
		bt_Find_path.setOnAction(e ->
		{
			...
			//[4, 4] [3, 4] [3, 5] [2, 5] [1, 5] [1, 6]

			AStar.startA(arrayINT, (int) (robot.getX() + 15) / 50 - 1, (int) (robot.getY() + 15) / 50 - 1, (int) (circle.getCenterX() / 50 - 1), (int) (circle.getCenterY() / 50 - 1));
